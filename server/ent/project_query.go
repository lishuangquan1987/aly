...
type ProjectQuery struct {
	...
	withChangeLogs *ProjectChangeLogQuery
...
func (_q *ProjectQuery) QueryChangeLogs() *ProjectChangeLogQuery {
	query := (&ProjectChangeLogClient{config: _q.config}).Query()
...
func (_q *ProjectQuery) WithChangeLogs(opts ...func(*ProjectChangeLogQuery)) *ProjectQuery {
	query := (&ProjectChangeLogClient{config: _q.config}).Query()
...
func (_q *ProjectQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Project, error) {
	...
	if query := _q.withChangeLogs; query != nil {
		if err := _q.loadChangeLogs(ctx, query, nodes,
			func(n *Project) { n.Edges.ChangeLogs = []*ProjectChangeLog{} },
			func(n *Project, e *ProjectChangeLog) { n.Edges.ChangeLogs = append(n.Edges.ChangeLogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ProjectQuery) loadChangeLogs(ctx context.Context, query *ProjectChangeLogQuery, nodes []*Project, init func(*Project), assign func(*Project, *ProjectChangeLog)) error {
