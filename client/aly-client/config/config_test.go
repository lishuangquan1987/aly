...
func TestShouldSkipFolder(t *testing.T) {
	tests := []struct {
		...
		{"glob 深层嵌套", "a/b/node_modules", []string{"**/node_modules"}, true},
		{"glob 任意深度 logs", "a/b/c/logs", []string{"**/logs"}, true},
		{"glob 零段匹配", "logs", []string{"**/logs"}, true},
		{"glob 中间段", "src/node_modules/dist", []string{"src/**/dist"}, true},
		{"glob 不匹配", "a/b/logs", []string{"**/temp"}, false},
